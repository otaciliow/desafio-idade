...
Este é um projeto simples utilizando React e Vite, uma ferramenta de build rápida e moderna para desenvolvimento front-end. Sua finalidade fazer o cálculo da idade do usuário baseado no ano de nascimento, e exibir a informação junto ao seu nome.
...
1. Clone o repositório e acesse o diretório:
   ```bash
   git clone https://github.com/otaciliow/desafio-idade.git
   cd desafio-idade
